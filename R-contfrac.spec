...
%setup -q -n contfrac
pushd ..
cp -a contfrac buildavx2
popd
pushd ..
cp -a contfrac buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737138078
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/contfrac/libs/contfrac.so
/V4/usr/lib64/R/library/contfrac/libs/contfrac.so
